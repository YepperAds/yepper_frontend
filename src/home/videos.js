            ...
            <main className="max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="mt-16 flex justify-center">
                    <div className="rounded-full px-6 py-3 bg-white/5 backdrop-blur-md flex items-center space-x-2">
                        <span className="text-white/60 text-sm">Can't find what you need?</span>
                        <button className="text-blue-400 text-sm font-medium hover:text-blue-300 transition-colors">Request a tutorial</button>
                    </div>
                </div>
            </main>
