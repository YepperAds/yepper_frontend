                    ...
                    <Card className="mb-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <CardHeader className="flex flex-row items-center gap-6 p-6">
                            ...
                            <div className="flex-1">
                                <CardTitle className="text-3xl font-bold mb-2">{website?.websiteName}</CardTitle>
                                <a 
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h2 className="text-xl font-semibold mb-1">{category.categoryName}</h2>
                                                ...
                                                <div className="relative bg-gray-50 rounded-xl p-1">
                                                    ...
                                                    >
                                                        {['HTML', 'JavaScript', 'PHP', 'Python'].map((lang) => (
                                                            <div key={lang} className="w-full flex-shrink-0 p-4">
                                                                <div className="flex justify-between items-center mb-3">
                                                                    <div className="flex items-center gap-2">
                                                                        <Code className="w-4 h-4 text-primary" />
                                                                        <h4 className="font-semibold text-gray-900">{lang}</h4>
                                                                    </div>
                                                                    <Button
                                                                        variant="ghost"
                                                                        size="sm"
                                                                ...
                                                                <pre className="text-sm bg-white p-4 rounded-lg border shadow-sm font-mono overflow-x-auto">
                                                    ...
                                                    <Button
                                                        variant="outline"
                                                        size="icon"
                                                        className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white shadow-md hover:bg-gray-50"
                                                    ...
                                                    <Button
                                                        variant="outline"
                                                        size="icon"
                                                        className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white shadow-md hover:bg-gray-50"
                                                        onClick={() => setCurrentSlides(prev => ({
                                                            ...prev,
