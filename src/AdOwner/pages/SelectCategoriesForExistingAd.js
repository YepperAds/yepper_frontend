...
const SelectCategoriesForExistingAd = () => {
  ...
  const fetchWalletInfo = async () => {
    try {
      const response = await axios.get(
        'https://yepper-backend.vercel.app/api/web-advertise/payment/wallet-balance',
  ...
  const calculatePaymentBreakdown = async () => {
    try {
      ...
      const response = await axios.post(
        'https://yepper-backend.vercel.app/api/web-advertise/payment/calculate-breakdown',
        { 
          selections,
  ...
  const handleProceedToPayment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://yepper-backend.vercel.app/api/web-advertise/${adId}/add-selections`,
        {
  ...
  const handlePayAllCategories = async () => {
    try {
      ...
      const response = await axios.post(
        'https://yepper-backend.vercel.app/api/web-advertise/payment/process-wallet',
        { 
          selections,
          isReassignment: isReassignment || false
        },
