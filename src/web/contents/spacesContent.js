...
//   // Toggle availability options for a specific category and space
...
//   // Handle availability option selection for a specific category and space
...
//   // Reset availability for a specific category and space
...
//   // Save date range for a specific category and space
...
//   // Submit spaces data to the database
...
//   // Render spaces for a specific category
//   const renderSpacesForCategory = (category) => (
//     <div className='spaces-inputs' key={category}>
//       <h3>{category.charAt(0).toUpperCase() + category.slice(1)} Category</h3>
  
//       <label className="space-checkbox">
//         <input
//           type="checkbox"
//           onChange={(e) => handleSpaceChange(category, 'header', 'checked', e.target.checked)}
//         />
//         Header
//       </label>
...
//             <span
//               className={`availability-span ${spaces[category]?.header?.availability !== 'Select Availability' ? 'selected' : ''}`}
...
//                     onClick={() => handleAvailabilityOptionClick(category, 'header', option)}
//                   >
//                     {option}
//                   </div>
//                 ))}
...
//             {spaces[category]?.header?.availability !== 'Select Availability' && (
//               <button className="reset-button" onClick={() => resetAvailability(category, 'header')}>
//                 Reset
//               </button>
//             )}
...
//                   dateFormat="dd/MM/yyyy"
//                 />
//                 <button onClick={() => saveDateRange(category, 'header')} className="save-date-button">
//                   Save
//                 </button>
//               </div>
//             )}
...
//   return (
//     <div className='web-spaces container'>
...
//       <button onClick={submitSpacesToDatabase} disabled={loading} className="submit-btn">
...
//   const webOwnerEmail = user.primaryEmailAddress.emailAddress;
//   const location = useLocation();
//   const { selectedCategories} = location.state; // Passed from Ads.js
//   const [spaces, setSpaces] = useState({});
//   const [loading, setLoading] = useState(false);
...
//             {spaces[category]?.header?.availability !== 'Select Availability' && (
//               <button onClick={() => resetAvailability(category, 'header')}>
//                 Reset
//               </button>
//             )}
...
//                   dateFormat="dd/MM/yyyy"
//                 />
//                 <button onClick={() => saveDateRange(category, 'header')}>
//                   Save
//                 </button>
//               </div>
//             )}
...
//         <input
//           type="checkbox"
//           onChange={(e) => handleSpaceChange(category, 'sidebar', 'checked', e.target.checked)}
//         />
//         Sidebar
//       </label>
//       {spaces[category]?.sidebar?.checked && (
//         <div>
//           <input
//             type="number"
//             placeholder="Price"
//             onChange={(e) => handleSpaceChange(category, 'sidebar', 'price', e.target.value)}
//           />
//           <input
//             type="number"
//             placeholder="User Count"
//             onChange={(e) => handleSpaceChange(category, 'sidebar', 'userCount', e.target.value)}
//           />
//           <input
//             type="text"
//             placeholder="Instructions"
//             onChange={(e) => handleSpaceChange(category, 'sidebar', 'instructions', e.target.value)}
//           />

//           <div className="availability-section" style={{ position: 'relative' }}>
//             <span
//               className={`availability-span ${spaces[category]?.sidebar?.availability !== 'Select Availability' ? 'selected' : ''}`}
//               onClick={() => handleAvailabilityClick(category, 'sidebar')}
//             >
//               {spaces[category]?.sidebar?.availability || 'Select Availability'}
//             </span>

//             {spaces[category]?.sidebar?.availabilityOptionsVisible && (
//               <div className="availability-options-container">
//                 {availabilityOptions.map((option, index) => (
//                   <div
//                     key={index}
//                     className="availability-option"
//                     onClick={() => handleAvailabilityOptionClick(category, 'sidebar', option)}
//                   >
//                     {option}
//                   </div>
//                 ))}
...
//             {spaces[category]?.sidebar?.availability !== 'Select Availability' && (
//               <button className="reset-button" onClick={() => resetAvailability(category, 'sidebar')}>
//                 Reset
//               </button>
//             )}

//             {spaces[category]?.sidebar?.isDatePickerVisible && (
//               <div className="date-picker-container">
//                 <DatePicker
//                   selected={spaces[category]?.sidebar?.startDate}
//                   onChange={(date) => handleSpaceChange(category, 'sidebar', 'startDate', date)}
//                   selectsStart
//                   startDate={spaces[category]?.sidebar?.startDate}
//                   endDate={spaces[category]?.sidebar?.endDate}
//                   minDate={new Date()}
//                   placeholderText="Start Date"
//                   dateFormat="dd/MM/yyyy"
//                 />
//                 <DatePicker
//                   selected={spaces[category]?.sidebar?.endDate}
//                   onChange={(date) => handleSpaceChange(category, 'sidebar', 'endDate', date)}
//                   selectsEnd
//                   startDate={spaces[category]?.sidebar?.startDate}
//                   endDate={spaces[category]?.sidebar?.endDate}
//                   minDate={spaces[category]?.sidebar?.startDate || new Date()}
//                   placeholderText="End Date"
//                   dateFormat="dd/MM/yyyy"
//                 />
//                 <button onClick={() => saveDateRange(category, 'sidebar')}>
//                   Save
//                 </button>
//               </div>
//             )}
